...
export class PublicUserAccountService {
    constructor(private http: HttpClient) { }

    accountSignInUrl = environment.apiUrl +'/api/Account/SignIn';

    /** POST: add a new hero to the database */
    // signIn(userLogin: Login): Observable<Login> {
    //     return this.http.get<Login>(this.accountSignInUrl, httpOptions)
    //         .pipe(catchError(e => throwError(e)));
    // }

    signIn(userLogin: Login): Observable<Login> {
        return this.http.post<Login>(this.accountSignInUrl, userLogin, httpOptions)
            .pipe(catchError(e => throwError(e)));
    }
    // getConfig() {
